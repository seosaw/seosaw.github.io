...
<table class="tablesorter" id="myTable">
  ...
  <tr>
    ...
    <td>If `plot_shape` == "circle", the angle (0 = North)
    direction of the stem from the plot centre, in degrees
    (0-360)</td>
  ...
  <tr>
    ...
    <td>If `plot_shape` == "circle", the distance of the stem from
    the plot centre. In metres to the nearest 10 cm</td>
  ...
  <tr>
    ...
    "hyposometer" if estimated using a Hagl&Atilde;&para;f Vertex
    Hypsometer, "direct" if estimated by climbing the tree or
    adjacent tower and measuring the height with tape, stick
    etc.</td>
